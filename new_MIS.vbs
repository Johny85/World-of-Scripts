...
Dim xlApp, filsys, TS, RegC, DB, ORS, intRow, RSO, RS, SLine, arr, strc
Dim DateF, DateC, ODate, IntC
...
xlApp.Workbooks.Open("C:\Users\PR172959\Desktop\Desktop Files\Sample\MIS.xlsx")
Set TS = xlApp.ActiveWorkbook.Worksheets("JAN")
...
ORS("Break") = TS.Cells(intRow,70).Value
ORS("MYACCSS") = TS.Cells(intRow,71).Value
ORS("MYACCTD") = TS.Cells(intRow,72).Value
ORS("MYACCBD") = TS.Cells(intRow,73).Value
ORS("ACCDETSS") = TS.Cells(intRow,74).Value
ORS("ACCDETTD") = TS.Cells(intRow,75).Value
ORS("ACCDETBD") = TS.Cells(intRow,76).Value
ORS("MINISSS") = TS.Cells(intRow,77).Value
ORS("MINISTD") = TS.Cells(intRow,78).Value
ORS("MINISBD") = TS.Cells(intRow,79).Value
ORS("BINVEST") = TS.Cells(intRow,80).Value
ORS("CBREQSS") = TS.Cells(intRow,81).Value
ORS("CBREQTD") = TS.Cells(intRow,82).Value
ORS("CBREQBD") = TS.Cells(intRow,83).Value
ORS("CHSTATSS") = TS.Cells(intRow,84).Value
ORS("CHSTATTD") = TS.Cells(intRow,85).Value
ORS("CHSTATBD") = TS.Cells(intRow,86).Value
ORS("STOPCHQSS") = TS.Cells(intRow,87).Value
ORS("STOPCHQTD") = TS.Cells(intRow,88).Value
ORS("STOPCHQBD") = TS.Cells(intRow,89).Value
ORS("AADHARSS") = TS.Cells(intRow,90).Value
ORS("AADHARTD") = TS.Cells(intRow,91).Value
ORS("AADHARBD") = TS.Cells(intRow,92).Value
ORS("ACCSTATSS") = TS.Cells(intRow,93).Value
ORS("ACCSTATTD") = TS.Cells(intRow,94).Value
ORS("ACCSTATBD") = TS.Cells(intRow,95).Value
ORS("INTCERTSS") = TS.Cells(intRow,96).Value
ORS("INTCERTTD") = TS.Cells(intRow,97).Value
ORS("INTCERTBD") = TS.Cells(intRow,98).Value
ORS("DCHOTSS") = TS.Cells(intRow,99).Value
ORS("DCHOTTD") = TS.Cells(intRow,100).Value
ORS("DCHOTBD") = TS.Cells(intRow,101).Value
ORS("TDSCERTSS") = TS.Cells(intRow,102).Value
ORS("TDSCERTTD") = TS.Cells(intRow,103).Value
ORS("TDSCERTBD") = TS.Cells(intRow,104).Value
ORS("FORM15SS") = TS.Cells(intRow,105).Value
ORS("FORM15TD") = TS.Cells(intRow,106).Value
ORS("FORM15BD") = TS.Cells(intRow,107).Value
ORS("NOMISS") = TS.Cells(intRow,108).Value
ORS("NOMITD") = TS.Cells(intRow,109).Value
ORS("NOMIBD") = TS.Cells(intRow,110).Value
ORS("DCREQSS") = TS.Cells(intRow,111).Value
ORS("DCREQTD") = TS.Cells(intRow,112).Value
ORS("DCREQBD") = TS.Cells(intRow,113).Value
ORS("ACCTFRSS") = TS.Cells(intRow,114).Value
ORS("ACCTFRTD") = TS.Cells(intRow,115).Value
ORS("ACCTFRBD") = TS.Cells(intRow,116).Value
ORS("FDRDCLSSS") = TS.Cells(intRow,117).Value
ORS("FDRDCLSTD") = TS.Cells(intRow,118).Value
ORS("FDRDCLSBD") = TS.Cells(intRow,119).Value
ORS("SSASS") = TS.Cells(intRow,120).Value
ORS("SSATD") = TS.Cells(intRow,121).Value
ORS("SSABD") = TS.Cells(intRow,122).Value
ORS("DGPSS") = TS.Cells(intRow,123).Value
ORS("DGPTD") = TS.Cells(intRow,124).Value
ORS("DGPBD") = TS.Cells(intRow,125).Value
ORS("IBREGSS") = TS.Cells(intRow,126).Value
ORS("IBREGTD") = TS.Cells(intRow,127).Value
ORS("IBREGBD") = TS.Cells(intRow,128).Value
ORS("IBPWDSS") = TS.Cells(intRow,129).Value
ORS("IBPWDTD") = TS.Cells(intRow,130).Value
ORS("IBPWDRD") = TS.Cells(intRow,131).Value
ORS("COMAILSS") = TS.Cells(intRow,132).Value
ORS("COMAILTD") = TS.Cells(intRow,133).Value
ORS("COMAILBD") = TS.Cells(intRow,134).Value
ORS("APYSS") = TS.Cells(intRow,135).Value
ORS("APYTD") = TS.Cells(intRow,136).Value
ORS("APYBD") = TS.Cells(intRow,137).Value
ORS.Update
