...
Dim DB, ORS, CMD, strFolder, FLD, fil, Line, strVar, DateC
...
If strVar = 0 AND (TSO.GetFile("C:\Campaign_Mails\RBNA_Res.csv").Size/1024) > 10000 Then
...
WS.Write "ZONE NAME|REGION NAME|SOL ID|CUSTOMER ID|CUSTOMER NAME|MOBILE NUMBER|REGISTRATION DATE|REGISTRATION CHANNEL|BRANCH_NAME" & vbCrLf
	...
	Loop
			...
			.Body = "Dear Sir/Madam," & vbCrLf & vbCrLf & "Kindly find attached registered but not activated data of mobile banking as on " & DateC & "." & vbCrLf & vbCrLf & vbCrLf & vbCrLf & "Thanks and Regards" & vbCrLf & "Pritimay" & vbCrLf & "Mobile Banking" & vbCrLf & "Fintech, Partnerships & Mobile Banking Dept." & vbCrLf & "Bank of Baroda" & vbCrLf & "Baroda Sun Tower, 6th Floor, C-34, G Block, BKC, Bandra (E), Mumbai - 400 051" & vbCrLf & "022 67592577"
			End With
