...
Dim DateC, DB, WSO, WS, RS, strvar, TS, i, j, FieldN, FieldV
Dim xlApp
...
DO WHILE NOT RS.EOF
If TS.Cells(39,01).Value = "" Then
TS.Cells(39,01).Value = "Decline in IMPS Technical Decline at Beneficiary End ("&RS.Fields(0)&") as reported by NPCI"
End If
RS.MoveNext
Loop
...
TS.Cells(37,1).Value = "Alerts* on NFS (IMPS) declines dated "&DateC&""
